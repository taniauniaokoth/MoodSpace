...
PROJECT DESCRIPTION
Mood Space is a web application designed to help users track, express, and understand their emotions simply and interactively. Many people experience mood changes but do not have an easy way to reflect on or manage them.
...
This project provides a digital space where users can log their moods, add short notes about how they feel, and view their emotional patterns over time. By combining a clean user interface with JavaScript functionality, the application transforms personal input into meaningful feedback.
 ...
 PROBLEM STATEMENT
Many individuals struggle to track their emotions consistently or reflect on their mental state over time. Without a structured system, it becomes difficult to identify patterns, triggers, or mood improvements.
